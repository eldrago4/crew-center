...
const MENU_LINKS = [
    [
        { label: "Routes", href: "/crew/career/routes" },
        { label: "Hubs", href: "/crew/career/hubs" },
        { label: "Ranks", href: "/crew/career/ranks" },
    ],
    [
        { label: "Live", href: "/crew/career/live" },
        { label: "Stats", href: "/crew/career/stats" },
        { label: "Briefings", href: "/crew/career/briefings" },
    ],
];
...
export function CareerMobileNavMenu() {
                    ...
                    <Box>
                        ...
                        >
                            <VStack align="stretch" spacing={2}>
                                <Link href="/crew/career/routes" color="gray.300">Routes</Link>
                                <Link href="/crew/career/ranks" color="gray.300">Ranks</Link>
                                <Link href="/crew/career/briefings" color="gray.300">Briefings</Link>
                                <Link href="/crew/career/fleet" color="gray.300">Fleet</Link>
                            </VStack>
                        </Box>
                    </Box>
                    <Link color="white" href="/crew/career/live" fontSize="xl" fontWeight="medium">
                        Live
                    </Link>
                    <Link color="white" href="/crew/career/events" fontSize="xl" fontWeight="medium">
                        Events
                    </Link>
                    <Link color="white" href="/crew/career/info" fontSize="xl" fontWeight="medium">
                        About
                    </Link>
                    <Link color="white" href="/crew/career/apply" fontSize="xl" fontWeight="medium">
                        Apply
                    </Link>
                </VStack>
            </Box>
