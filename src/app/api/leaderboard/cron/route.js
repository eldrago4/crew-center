...
// stays callable in environments where it isn't set — same contract as
// /api/badges/cron. Without this the route was public: anyone could trigger a
// full users scan + Redis write + Discord role reconciliation.
